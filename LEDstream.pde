//	This is a modified version of the original LEDstream sketch from Adafruit. Original file here:
//	https://github.com/adafruit/Adalight/blob/master/Arduino/LEDstream/LEDstream.pde
//
//	This modified version has a higher BAUD rate (256k) for better bandwidth, the color cycling used for debugging has been
//		removed, and the timeout has been significantly reduced. It is recommended that you set up your arduino
//		with the original code first to make sure wiring is correct, and then upload this code to the arduino when ready.
...
static const unsigned long serialTimeout = 2000; // 2 seconds
...
void setup()
{
  ...
  Serial.begin(256000); // Teensy/32u4 disregards baud rate; is OK!
